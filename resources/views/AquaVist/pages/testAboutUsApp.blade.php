...
<head>
    ...
    <link rel='stylesheet' id='elementor-global-css'
        ...
        media='all' />
    <link rel='stylesheet' id='elementor-post-788-css'
        href='{{ asset('AquaVist/wp-content/uploads/sites/129/elementor/css/post-78899ce.css?ver=1700604595') }}'
        media='all' />
    ...
    <script src="{{ asset('AquaVist/wp-includes/js/jquery/jquery-migrate.min5589.js?ver=3.4.1') }}" id="jquery-migrate-js">
    </script>
    <script
    ...
    <link rel="alternate" type="application/json" href="{{ asset('AquaVist/wp-json/wp/v2/pages/788.json') }}" />
    <link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.html?rsd" />
    <meta name="generator" content="WordPress 6.4.1" />
    <link rel="canonical" href="index.html" />
    <link rel='shortlink' href='../indexc2d1.html?p=788' />
    <link rel="alternate" type="application/json+oembed"
        href="{{ asset('AquaVist/wp-json/oembed/1.0/embedd5cb.json?url=https%3A%2F%2Ftemplatekit.jegtheme.com%2Faquavist%2Fabout%2F') }}" />
    <link rel="alternate" type="text/xml+oembed"
        href="{{ asset('AquaVist/wp-json/oembed/1.0/embedab09?url=https%3A%2F%2Ftemplatekit.jegtheme.com%2Faquavist%2Fabout%2F&amp;format=xml') }}" />
    <meta name="generator"
...
<body
    class="page-template page-template-elementor_header_footer page page-id-788 ehf-header ehf-footer ehf-template-hello-elementor ehf-stylesheet-hello-elementor jkit-color-scheme elementor-default elementor-template-full-width elementor-kit-4 elementor-page elementor-page-788">
    <main>
        @yield('content')
    </main>
    ...
    <link rel='stylesheet' id='sweetalert2-css'
        href='{{ asset('AquaVist/wp-content/plugins/jeg-elementor-kit/assets/js/sweetalert2/sweetalert2.min430c.css?ver=11.6.16') }}'
        media='all' />
    ...
    <script id="elementor-frontend-js-before">
        var elementorFrontendConfig = {
            ...
            "post": {
                "id": 788,
                "title": "About%20%E2%80%93%20Aquavist",
                "excerpt": "",
                "featuredImage": false
            }
        };
    ...
    <script src="{{ asset('AquaVist/wp-content/plugins/jeg-elementor-kit/assets/js/elements/nav-menu61da.js?ver=2.6.2') }}"
        id="jkit-element-navmenu-js"></script>
    <script
        src="{{ asset('AquaVist/wp-content/plugins/jeg-elementor-kit/assets/js/elements/video-button61da.js?ver=2.6.2') }}"
        id="jkit-element-videobutton-js"></script>
    <script
        src="{{ asset('AquaVist/wp-content/plugins/jeg-elementor-kit/assets/js/sweetalert2/sweetalert2.min430c.js?ver=11.6.16') }}"
        id="sweetalert2-js"></script>
    <script
        src="{{ asset('AquaVist/wp-content/plugins/jeg-elementor-kit/assets/js/elements/progress-bar61da.js?ver=2.6.2') }}"
        id="jkit-element-progressbar-js"></script>
    <script
        src="{{ asset('AquaVist/wp-content/plugins/jeg-elementor-kit/assets/js/elements/accordion61da.js?ver=2.6.2') }}"
...
<!-- Mirrored from templatekit.jegtheme.com/aquavist/about/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Dec 2024 07:34:12 GMT -->
